  ...
  CandidateScored AS (
    SELECT
      *,
      ...
      REGEXP_CONTAINS(
        event_hint_u,
        r'OPENAI|CHATGPT|ANTHROPIC|CLAUDE|CLAUDE[ _-]?CODE|DEEPMIND|GEMINI|META[ _-]?AI|LLAMA|MICROSOFT[ _-]?COPILOT|GITHUB[ _-]?COPILOT|NVIDIA|XAI|GROK|MISTRAL|COHERE|HUGGING[ _-]?FACE|STABILITY[ _-]?AI|MIDJOURNEY|RUNWAY|KLING|VEO|SORA|HUNYUANVIDEO|PERPLEXITY|DEEPSEEK|QWEN|GLM|Z[.]AI|ZHIPU|智谱|BIGMODEL|ALIBABA|BAIDU|ERNIE|TENCENT|HUNYUAN|HUAWEI|PANGU|BYTEDANCE|DOUBAO|MINIMAX|MOONSHOT|KIMI|SENSETIME|IFLYTEK|HYPERCLOVA|YANDEXGPT|GIGACHAT|FALCON[ _-]?LLM|MBZUAI|CEREBRAS|GROQ|SAMBANOVA|COREWEAVE|DATABRICKS|OPENROUTER|REPLICATE|FAL[.]AI|BLACK[ _-]?FOREST[ _-]?LABS|FLUX|COMFYUI|STABLE[ _-]?DIFFUSION|LORA|CONTROLNET|SDXL|LANGCHAIN|LANGGRAPH|LLAMAINDEX|MCP|OPENHANDS|CURSOR|OLLAMA|VLLM|SGLANG|PYTORCH|TENSORFLOW'
      ) AS has_entity,
      REGEXP_CONTAINS(
        event_hint_u,
