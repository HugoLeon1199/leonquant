...
- generated_at_utc: 2026-07-10T20:46:21.632200+00:00
...
- candidates_by_method: {'manual_signal': 51, 'github_api': 30, 'hf_api': 27, 'api': 8, 'arxiv_api': 10, 'html': 14, 'gdelt': 38}
- content_quality_mix: {'metadata_only': 104, 'summary_only': 60, 'full_text': 14}
...
| independent_ai_news | 0 | 0 | 0 | 0 | 0 | 56 | method:arxiv_api=10, method:gdelt=38, method:html=8, quality:full_text=8, quality:summary_only=48 | low active URL crawl count | add RSS/API/direct metadata strategy |
...
| automation_agents | 0 | 26 | 4 | 0 | 0 | 50 | method:arxiv_api=1, method:gdelt=21, method:github_api=10, method:hf_api=1, method:html=5, method:manual_signal=12, quality:full_text=5, quality:metadata_only=16, quality:summary_only=29 | - | monitor |
...
| community_forums | 1 | 0 | 0 | 1 | 0 | 6 | method:html=6, quality:full_text=6 | - | monitor |
