...
## 2026-08-22 - Technology & AI 72h live run

- Tech72h generated_at=2026-08-22T02:32:26.657261+00:00
- Scope: standalone `tech/`; Tin48h, Invest and World LIVE logic unchanged.
- Format: AI Frontier Radar 72h.
- Schedule: once every 3 days; data window: latest 72 hours.
- Active sources: 63 / 84.
- Clean web articles: 502.
- Candidate live: 644; noise bi loai: 24; bai qua han 72h bi loai khoi section chinh: 24.
- Event candidates: 28; GDELT ran_successfully=True; raw=120; ai_filtered=28; rejected_non_ai=92.
- Query estimate: 1,295,281,861 bytes; processed: 1,295,281,861 bytes; bytes_status=known; cap: 2,000,000,000 bytes.
- Published stories: 502; must_read=20; full_link_radar=150.
- Must Read theo source type: {'independent': 15, 'official': 5}.
- Must Read theo category: {'model': 4, 'local_ai': 1, 'tool': 9, 'automation': 1, 'opensource': 1, 'business': 1, 'knowledge': 1, 'industry': 1, 'mcp': 1}.
- Frontier Watchlist entities: 26; candidates_from_watchlist=116; GLM-5.2 detected=yes.
- Data coverage: active_url_sources=63; active_api_sources=27; active_rss_sources=63; active_sitemap_sources=0; active_watchlist_entities=26; metadata_only_sources=46.
- Source registry P0: configured=31; checked=31; success=31; failed=0; zero_hit=0; missing_critical=[].
- Registry quality: verified_timestamp_ratio=1.0; content_quality_ratio={'full_text': 0.0, 'summary_only': 0.528, 'metadata_only': 0.472}; primary/independent/community=27/63/19.
- API candidates: total=125; by_method={'hf_api': 27, 'github_api': 42, 'arxiv_api': 9, 'api': 8}; notes=['profile AMD AI Blog: HTTP Error 404: Not Found', 'profile Intel AI Blog: HTTP Error 403: Forbidden', 'profile Arm AI Blog: The read operation timed out'].
- Input quality: real_candidate_count=644; manual_signal_count=0; weak_metadata_match_count=15; official_org_candidate_count=63.
- candidates_by_method={'github_api': 42, 'hf_api': 27, 'api': 8, 'changelog_snapshot': 5, 'metadata': 4, 'rss': 27, 'html': 499, 'arxiv_api': 9, 'gdelt': 23}; content_quality_mix={'metadata_only': 59, 'summary_only': 86, 'full_text': 499}; remaining CAPTCHA/paywall/JS-only sources=0.
- Source mix main candidates: official=10, independent=66, community=0.
- Pages workflow includes Tech Radar: yes.
- Gemini curator: success=46; fallback=54; ai_main=28; fallback_main=48.
- Section counts: local_ai=8, automation=6, open_source=2, knowledge=4, founder_ideas=10.
- /tech/ render check: knowledge=True; founder_ideas=True.
- Tests: `python tech/test_pipeline.py` and `python tech/validate_publication.py` passed.

## 2026-08-25 - Technology & AI 72h live run

- Tech72h generated_at=2026-08-25T08:05:09.645877+00:00
- Scope: standalone `tech/`; Tin48h, Invest and World LIVE logic unchanged.
- Format: AI Frontier Radar 72h.
- Schedule: once every 3 days; data window: latest 72 hours.
- Active sources: 63 / 84.
- Clean web articles: 568.
- Candidate live: 707; noise bi loai: 23; bai qua han 72h bi loai khoi section chinh: 30.
- Event candidates: 43; GDELT ran_successfully=True; raw=120; ai_filtered=43; rejected_non_ai=77.
- Query estimate: 1,111,027,987 bytes; processed: 1,111,027,987 bytes; bytes_status=known; cap: 2,000,000,000 bytes.
- Published stories: 568; must_read=20; full_link_radar=150.
- Must Read theo source type: {'independent': 14, 'official': 6}.
- Must Read theo category: {'model': 2, 'local_ai': 1, 'tool': 8, 'automation': 1, 'opensource': 1, 'business': 3, 'industry': 4}.
- Frontier Watchlist entities: 26; candidates_from_watchlist=106; GLM-5.2 detected=no.
- Data coverage: active_url_sources=63; active_api_sources=27; active_rss_sources=63; active_sitemap_sources=0; active_watchlist_entities=26; metadata_only_sources=46.
- Source registry P0: configured=31; checked=31; success=31; failed=0; zero_hit=0; missing_critical=[].
- Registry quality: verified_timestamp_ratio=1.0; content_quality_ratio={'full_text': 0.0, 'summary_only': 0.4957, 'metadata_only': 0.5043}; primary/independent/community=27/63/19.
- API candidates: total=115; by_method={'hf_api': 26, 'github_api': 42, 'arxiv_api': 0, 'api': 8}; notes=['profile AMD AI Blog: HTTP Error 404: Not Found', 'profile Intel AI Blog: HTTP Error 403: Forbidden', 'profile Arm AI Blog: The read operation timed out'].
- Input quality: real_candidate_count=707; manual_signal_count=0; weak_metadata_match_count=14; official_org_candidate_count=60.
- candidates_by_method={'github_api': 42, 'hf_api': 26, 'api': 8, 'changelog_snapshot': 5, 'metadata': 4, 'rss': 27, 'html': 565, 'gdelt': 30}; content_quality_mix={'metadata_only': 58, 'summary_only': 84, 'full_text': 565}; remaining CAPTCHA/paywall/JS-only sources=0.
- Source mix main candidates: official=7, independent=70, community=0.
- Pages workflow includes Tech Radar: yes.
- Gemini curator: success=44; fallback=56; ai_main=25; fallback_main=52.
- Section counts: local_ai=12, automation=2, open_source=12, knowledge=4, founder_ideas=10.
- /tech/ render check: knowledge=True; founder_ideas=True.
- Tests: `python tech/test_pipeline.py` and `python tech/validate_publication.py` passed.

## 2026-08-28 - Technology & AI 72h live run

- Tech72h generated_at=2026-08-28T12:51:39.927356+00:00
- Scope: standalone `tech/`; Tin48h, Invest and World LIVE logic unchanged.
- Format: AI Frontier Radar 72h.
- Schedule: once every 3 days; data window: latest 72 hours.
- Active sources: 63 / 84.
- Clean web articles: 674.
- Candidate live: 840; noise bi loai: 8; bai qua han 72h bi loai khoi section chinh: 22.
- Event candidates: 60; GDELT ran_successfully=True; raw=120; ai_filtered=60; rejected_non_ai=60.
- Query estimate: 1,618,625,263 bytes; processed: 1,618,625,263 bytes; bytes_status=known; cap: 2,000,000,000 bytes.
- Published stories: 674; must_read=20; full_link_radar=150.
- Must Read theo source type: {'official': 5, 'independent': 15}.
- Must Read theo category: {'model': 3, 'local_ai': 1, 'tool': 12, 'opensource': 1, 'business': 2, 'industry': 1}.
- Frontier Watchlist entities: 26; candidates_from_watchlist=115; GLM-5.2 detected=no.
- Data coverage: active_url_sources=63; active_api_sources=27; active_rss_sources=63; active_sitemap_sources=0; active_watchlist_entities=26; metadata_only_sources=46.
- Source registry P0: configured=31; checked=31; success=31; failed=0; zero_hit=0; missing_critical=[].
- Registry quality: verified_timestamp_ratio=1.0; content_quality_ratio={'full_text': 0.0, 'summary_only': 0.528, 'metadata_only': 0.472}; primary/independent/community=27/63/19.
- API candidates: total=125; by_method={'hf_api': 27, 'github_api': 42, 'arxiv_api': 9, 'api': 8}; notes=['profile AMD AI Blog: HTTP Error 404: Not Found', 'profile Intel AI Blog: HTTP Error 403: Forbidden', 'profile Arm AI Blog: The read operation timed out'].
- Input quality: real_candidate_count=840; manual_signal_count=0; weak_metadata_match_count=14; official_org_candidate_count=62.
- candidates_by_method={'github_api': 42, 'hf_api': 27, 'api': 8, 'changelog_snapshot': 5, 'metadata': 4, 'rss': 27, 'html': 674, 'arxiv_api': 9, 'gdelt': 44}; content_quality_mix={'metadata_only': 59, 'summary_only': 107, 'full_text': 674}; remaining CAPTCHA/paywall/JS-only sources=0.
- Source mix main candidates: official=9, independent=83, community=0.
- Pages workflow includes Tech Radar: yes.
- Gemini curator: success=28; fallback=72; ai_main=26; fallback_main=66.
- Section counts: local_ai=12, automation=7, open_source=10, knowledge=3, founder_ideas=10.
- /tech/ render check: knowledge=True; founder_ideas=True.
- Tests: `python tech/test_pipeline.py` and `python tech/validate_publication.py` passed.

## 2026-08-31 - Technology & AI 72h live run

- Tech72h generated_at=2026-08-31T15:13:02.061615+00:00
- Scope: standalone `tech/`; Tin48h, Invest and World LIVE logic unchanged.
- Format: AI Frontier Radar 72h.
- Schedule: once every 3 days; data window: latest 72 hours.
- Active sources: 63 / 84.
- Clean web articles: 518.
- Candidate live: 656; noise bi loai: 17; bai qua han 72h bi loai khoi section chinh: 33.
- Event candidates: 21; GDELT ran_successfully=True; raw=120; ai_filtered=21; rejected_non_ai=99.
- Query estimate: 1,089,847,237 bytes; processed: 1,089,847,237 bytes; bytes_status=known; cap: 2,000,000,000 bytes.
- Published stories: 518; must_read=20; full_link_radar=150.
- Must Read theo source type: {'independent': 17, 'official': 3}.
- Must Read theo category: {'model': 1, 'local_ai': 1, 'tool': 13, 'automation': 1, 'opensource': 1, 'business': 1, 'knowledge': 1, 'industry': 1}.
- Frontier Watchlist entities: 26; candidates_from_watchlist=115; GLM-5.2 detected=no.
- Data coverage: active_url_sources=63; active_api_sources=27; active_rss_sources=63; active_sitemap_sources=0; active_watchlist_entities=26; metadata_only_sources=46.
- Source registry P0: configured=31; checked=31; success=31; failed=0; zero_hit=0; missing_critical=[].
- Registry quality: verified_timestamp_ratio=1.0; content_quality_ratio={'full_text': 0.0, 'summary_only': 0.528, 'metadata_only': 0.472}; primary/independent/community=27/63/19.
- API candidates: total=125; by_method={'hf_api': 27, 'github_api': 42, 'arxiv_api': 9, 'api': 8}; notes=['profile AMD AI Blog: HTTP Error 404: Not Found', 'profile Intel AI Blog: HTTP Error 403: Forbidden', 'profile Arm AI Blog: The read operation timed out'].
- Input quality: real_candidate_count=656; manual_signal_count=0; weak_metadata_match_count=12; official_org_candidate_count=66.
- candidates_by_method={'hf_api': 27, 'github_api': 42, 'api': 8, 'changelog_snapshot': 5, 'metadata': 4, 'html': 518, 'rss': 30, 'arxiv_api': 9, 'gdelt': 13}; content_quality_mix={'metadata_only': 59, 'summary_only': 79, 'full_text': 518}; remaining CAPTCHA/paywall/JS-only sources=0.
- Source mix main candidates: official=3, independent=80, community=0.
- Pages workflow includes Tech Radar: yes.
- Gemini curator: success=32; fallback=68; ai_main=25; fallback_main=58.
- Section counts: local_ai=12, automation=4, open_source=7, knowledge=4, founder_ideas=10.
- /tech/ render check: knowledge=True; founder_ideas=True.
- Tests: `python tech/test_pipeline.py` and `python tech/validate_publication.py` passed.

## 2026-09-06 - Technology & AI 72h live run

- Tech72h generated_at=2026-09-06T06:03:22.353486+00:00
- Scope: standalone `tech/`; Tin48h, Invest and World LIVE logic unchanged.
- Format: AI Frontier Radar 72h.
- Schedule: once every 3 days; data window: latest 72 hours.
- Active sources: 63 / 84.
- Clean web articles: 312.
- Candidate live: 480; noise bi loai: 24; bai qua han 72h bi loai khoi section chinh: 28.
- Event candidates: 61; GDELT ran_successfully=True; raw=120; ai_filtered=61; rejected_non_ai=59.
- Query estimate: 1,046,119,271 bytes; processed: 1,046,119,271 bytes; bytes_status=known; cap: 2,000,000,000 bytes.
- Published stories: 312; must_read=20; full_link_radar=150.
- Must Read theo source type: {'independent': 14, 'official': 6}.
- Must Read theo category: {'model': 1, 'local_ai': 2, 'tool': 10, 'opensource': 1, 'business': 1, 'knowledge': 1, 'industry': 1, 'agent': 3}.
- Frontier Watchlist entities: 26; candidates_from_watchlist=89; GLM-5.2 detected=no.
- Data coverage: active_url_sources=63; active_api_sources=27; active_rss_sources=63; active_sitemap_sources=0; active_watchlist_entities=26; metadata_only_sources=46.
- Source registry P0: configured=31; checked=31; success=31; failed=0; zero_hit=0; missing_critical=[].
- Registry quality: verified_timestamp_ratio=1.0; content_quality_ratio={'full_text': 0.0, 'summary_only': 0.5081, 'metadata_only': 0.4919}; primary/independent/community=27/63/19.
- API candidates: total=124; by_method={'hf_api': 27, 'github_api': 42, 'arxiv_api': 8, 'api': 8}; notes=['profile AMD AI Blog: HTTP Error 404: Not Found', 'profile Intel AI Blog: HTTP Error 403: Forbidden', 'profile Arm AI Blog: The read operation timed out'].
- Input quality: real_candidate_count=480; manual_signal_count=0; weak_metadata_match_count=13; official_org_candidate_count=65.
- candidates_by_method={'github_api': 42, 'hf_api': 27, 'api': 8, 'changelog_snapshot': 5, 'metadata': 4, 'html': 312, 'rss': 30, 'arxiv_api': 8, 'gdelt': 44}; content_quality_mix={'metadata_only': 61, 'summary_only': 107, 'full_text': 312}; remaining CAPTCHA/paywall/JS-only sources=0.
- Source mix main candidates: official=6, independent=70, community=0.
- Pages workflow includes Tech Radar: yes.
- Gemini curator: success=33; fallback=67; ai_main=23; fallback_main=53.
- Section counts: local_ai=12, automation=3, open_source=11, knowledge=3, founder_ideas=10.
- /tech/ render check: knowledge=True; founder_ideas=True.
- Tests: `python tech/test_pipeline.py` and `python tech/validate_publication.py` passed.

## 2026-09-09 - Technology & AI 72h live run

- Tech72h generated_at=2026-09-09T12:24:57.920289+00:00
- Scope: standalone `tech/`; Tin48h, Invest and World LIVE logic unchanged.
- Format: AI Frontier Radar 72h.
- Schedule: once every 3 days; data window: latest 72 hours.
- Active sources: 63 / 84.
- Clean web articles: 638.
- Candidate live: 792; noise bi loai: 15; bai qua han 72h bi loai khoi section chinh: 34.
- Event candidates: 53; GDELT ran_successfully=True; raw=120; ai_filtered=53; rejected_non_ai=67.
- Query estimate: 1,467,719,335 bytes; processed: 1,467,719,335 bytes; bytes_status=known; cap: 2,000,000,000 bytes.
- Published stories: 638; must_read=20; full_link_radar=150.
- Must Read theo source type: {'independent': 16, 'official': 4}.
- Must Read theo category: {'model': 2, 'local_ai': 1, 'tool': 11, 'automation': 1, 'opensource': 1, 'business': 1, 'industry': 1, 'agent': 2}.
- Frontier Watchlist entities: 26; candidates_from_watchlist=103; GLM-5.2 detected=no.
- Data coverage: active_url_sources=63; active_api_sources=27; active_rss_sources=63; active_sitemap_sources=0; active_watchlist_entities=26; metadata_only_sources=46.
- Source registry P0: configured=31; checked=31; success=31; failed=0; zero_hit=0; missing_critical=[].
- Registry quality: verified_timestamp_ratio=1.0; content_quality_ratio={'full_text': 0.0, 'summary_only': 0.5161, 'metadata_only': 0.4839}; primary/independent/community=27/63/19.
- API candidates: total=124; by_method={'hf_api': 27, 'github_api': 42, 'arxiv_api': 8, 'api': 8}; notes=['profile AMD AI Blog: HTTP Error 404: Not Found', 'profile Intel AI Blog: HTTP Error 403: Forbidden', 'profile Arm AI Blog: The read operation timed out'].
- Input quality: real_candidate_count=792; manual_signal_count=0; weak_metadata_match_count=16; official_org_candidate_count=62.
- candidates_by_method={'github_api': 42, 'hf_api': 27, 'api': 8, 'changelog_snapshot': 5, 'metadata': 4, 'html': 637, 'arxiv_api': 8, 'rss': 27, 'gdelt': 34}; content_quality_mix={'metadata_only': 60, 'summary_only': 95, 'full_text': 637}; remaining CAPTCHA/paywall/JS-only sources=0.
- Source mix main candidates: official=5, independent=80, community=0.
- Pages workflow includes Tech Radar: yes.
- Gemini curator: success=42; fallback=58; ai_main=33; fallback_main=52.
- Section counts: local_ai=12, automation=4, open_source=4, knowledge=4, founder_ideas=10.
- /tech/ render check: knowledge=True; founder_ideas=True.
- Tests: `python tech/test_pipeline.py` and `python tech/validate_publication.py` passed.

## 2026-09-12 - Technology & AI 72h live run

- Tech72h generated_at=2026-09-12T16:26:29.911149+00:00
- Scope: standalone `tech/`; Tin48h, Invest and World LIVE logic unchanged.
- Format: AI Frontier Radar 72h.
- Schedule: once every 3 days; data window: latest 72 hours.
- Active sources: 63 / 84.
- Clean web articles: 578.
- Candidate live: 722; noise bi loai: 12; bai qua han 72h bi loai khoi section chinh: 28.
- Event candidates: 51; GDELT ran_successfully=True; raw=120; ai_filtered=51; rejected_non_ai=69.
- Query estimate: 1,543,480,532 bytes; processed: 1,543,480,532 bytes; bytes_status=known; cap: 2,000,000,000 bytes.
- Published stories: 578; must_read=20; full_link_radar=150.
- Must Read theo source type: {'independent': 15, 'official': 5}.
- Must Read theo category: {'model': 2, 'local_ai': 2, 'tool': 8, 'automation': 2, 'opensource': 2, 'business': 1, 'industry': 1, 'mcp': 1, 'agent': 1}.
- Frontier Watchlist entities: 26; candidates_from_watchlist=108; GLM-5.2 detected=no.
- Data coverage: active_url_sources=63; active_api_sources=27; active_rss_sources=63; active_sitemap_sources=0; active_watchlist_entities=26; metadata_only_sources=46.
- Source registry P0: configured=31; checked=31; success=31; failed=0; zero_hit=0; missing_critical=[].
- Registry quality: verified_timestamp_ratio=1.0; content_quality_ratio={'full_text': 0.0, 'summary_only': 0.4649, 'metadata_only': 0.5351}; primary/independent/community=27/63/19.
- API candidates: total=114; by_method={'hf_api': 27, 'github_api': 42, 'arxiv_api': 0, 'api': 8}; notes=['profile AMD AI Blog: HTTP Error 404: Not Found', 'profile Intel AI Blog: HTTP Error 403: Forbidden', 'profile Arm AI Blog: The read operation timed out'].
- Input quality: real_candidate_count=722; manual_signal_count=0; weak_metadata_match_count=14; official_org_candidate_count=63.
- candidates_by_method={'github_api': 42, 'hf_api': 27, 'api': 8, 'changelog_snapshot': 5, 'metadata': 5, 'html': 578, 'rss': 24, 'gdelt': 33}; content_quality_mix={'metadata_only': 61, 'summary_only': 83, 'full_text': 578}; remaining CAPTCHA/paywall/JS-only sources=0.
- Source mix main candidates: official=7, independent=81, community=0.
- Pages workflow includes Tech Radar: yes.
- Gemini curator: success=30; fallback=70; ai_main=24; fallback_main=64.
- Section counts: local_ai=12, automation=6, open_source=4, knowledge=4, founder_ideas=10.
- /tech/ render check: knowledge=True; founder_ideas=True.
- Tests: `python tech/test_pipeline.py` and `python tech/validate_publication.py` passed.

## 2026-09-15 - Technology & AI 72h live run

- Tech72h generated_at=2026-09-15T18:11:41.693960+00:00
- Scope: standalone `tech/`; Tin48h, Invest and World LIVE logic unchanged.
- Format: AI Frontier Radar 72h.
- Schedule: once every 3 days; data window: latest 72 hours.
- Active sources: 63 / 84.
- Clean web articles: 494.
- Candidate live: 632; noise bi loai: 10; bai qua han 72h bi loai khoi section chinh: 30.
- Event candidates: 26; GDELT ran_successfully=True; raw=120; ai_filtered=26; rejected_non_ai=94.
- Query estimate: 1,421,180,021 bytes; processed: 1,421,180,021 bytes; bytes_status=known; cap: 2,000,000,000 bytes.
- Published stories: 494; must_read=20; full_link_radar=150.
- Must Read theo source type: {'independent': 10, 'official': 10}.
- Must Read theo category: {'model': 2, 'local_ai': 1, 'tool': 13, 'automation': 1, 'opensource': 1, 'business': 1, 'industry': 1}.
- Frontier Watchlist entities: 26; candidates_from_watchlist=96; GLM-5.2 detected=no.
- Data coverage: active_url_sources=63; active_api_sources=27; active_rss_sources=63; active_sitemap_sources=0; active_watchlist_entities=26; metadata_only_sources=46.
- Source registry P0: configured=31; checked=31; success=31; failed=0; zero_hit=0; missing_critical=[].
- Registry quality: verified_timestamp_ratio=1.0; content_quality_ratio={'full_text': 0.0, 'summary_only': 0.5122, 'metadata_only': 0.4878}; primary/independent/community=27/63/19.
- API candidates: total=123; by_method={'hf_api': 27, 'github_api': 42, 'arxiv_api': 7, 'api': 8}; notes=['profile AMD AI Blog: HTTP Error 404: Not Found', 'profile Intel AI Blog: HTTP Error 403: Forbidden', 'profile Arm AI Blog: The read operation timed out'].
- Input quality: real_candidate_count=632; manual_signal_count=0; weak_metadata_match_count=14; official_org_candidate_count=63.
- candidates_by_method={'github_api': 42, 'hf_api': 27, 'api': 8, 'changelog_snapshot': 5, 'metadata': 4, 'rss': 27, 'html': 491, 'arxiv_api': 7, 'gdelt': 21}; content_quality_mix={'metadata_only': 60, 'summary_only': 81, 'full_text': 491}; remaining CAPTCHA/paywall/JS-only sources=0.
- Source mix main candidates: official=11, independent=79, community=0.
- Pages workflow includes Tech Radar: yes.
- Gemini curator: success=22; fallback=78; ai_main=17; fallback_main=73.
- Section counts: local_ai=12, automation=8, open_source=12, knowledge=4, founder_ideas=10.
- /tech/ render check: knowledge=True; founder_ideas=True.
- Tests: `python tech/test_pipeline.py` and `python tech/validate_publication.py` passed.

## 2026-09-18 - Technology & AI 72h live run

- Tech72h generated_at=2026-09-18T21:46:19.387018+00:00
- Scope: standalone `tech/`; Tin48h, Invest and World LIVE logic unchanged.
- Format: AI Frontier Radar 72h.
- Schedule: once every 3 days; data window: latest 72 hours.
- Active sources: 63 / 84.
- Clean web articles: 472.
- Candidate live: 624; noise bi loai: 15; bai qua han 72h bi loai khoi section chinh: 30.
- Event candidates: 61; GDELT ran_successfully=True; raw=120; ai_filtered=61; rejected_non_ai=59.
- Query estimate: 1,850,046,726 bytes; processed: 1,850,046,726 bytes; bytes_status=known; cap: 2,000,000,000 bytes.
- Published stories: 472; must_read=20; full_link_radar=150.
- Must Read theo source type: {'official': 11, 'independent': 9}.
- Must Read theo category: {'model': 3, 'local_ai': 1, 'tool': 5, 'automation': 2, 'opensource': 1, 'business': 1, 'industry': 3, 'agent': 4}.
- Frontier Watchlist entities: 26; candidates_from_watchlist=111; GLM-5.2 detected=no.
- Data coverage: active_url_sources=63; active_api_sources=27; active_rss_sources=63; active_sitemap_sources=0; active_watchlist_entities=26; metadata_only_sources=46.
- Source registry P0: configured=31; checked=31; success=31; failed=0; zero_hit=0; missing_critical=[].
- Registry quality: verified_timestamp_ratio=1.0; content_quality_ratio={'full_text': 0.0, 'summary_only': 0.4828, 'metadata_only': 0.5172}; primary/independent/community=27/63/19.
- API candidates: total=116; by_method={'hf_api': 27, 'github_api': 42, 'arxiv_api': 0, 'api': 8}; notes=['profile AMD AI Blog: HTTP Error 404: Not Found', 'profile Intel AI Blog: HTTP Error 403: Forbidden', 'profile Arm AI Blog: The read operation timed out'].
- Input quality: real_candidate_count=624; manual_signal_count=0; weak_metadata_match_count=13; official_org_candidate_count=63.
- candidates_by_method={'github_api': 42, 'hf_api': 27, 'api': 8, 'changelog_snapshot': 5, 'metadata': 4, 'rss': 27, 'html': 471, 'gdelt': 40}; content_quality_mix={'metadata_only': 60, 'summary_only': 93, 'full_text': 471}; remaining CAPTCHA/paywall/JS-only sources=0.
- Source mix main candidates: official=14, independent=71, community=0.
- Pages workflow includes Tech Radar: yes.
- Gemini curator: success=30; fallback=70; ai_main=24; fallback_main=61.
- Section counts: local_ai=9, automation=8, open_source=12, knowledge=4, founder_ideas=10.
- /tech/ render check: knowledge=True; founder_ideas=True.
- Tests: `python tech/test_pipeline.py` and `python tech/validate_publication.py` passed.

## 2026-09-21 - Technology & AI 72h live run

- Tech72h generated_at=2026-09-21T22:39:14.659710+00:00
- Scope: standalone `tech/`; Tin48h, Invest and World LIVE logic unchanged.
- Format: AI Frontier Radar 72h.
- Schedule: once every 3 days; data window: latest 72 hours.
- Active sources: 63 / 84.
- Clean web articles: 532.
- Candidate live: 666; noise bi loai: 17; bai qua han 72h bi loai khoi section chinh: 27.
- Event candidates: 41; GDELT ran_successfully=True; raw=120; ai_filtered=41; rejected_non_ai=79.
- Query estimate: 1,285,199,010 bytes; processed: 1,285,199,010 bytes; bytes_status=known; cap: 2,000,000,000 bytes.
- Published stories: 532; must_read=20; full_link_radar=150.
- Must Read theo source type: {'independent': 12, 'official': 8}.
- Must Read theo category: {'model': 3, 'local_ai': 1, 'tool': 8, 'automation': 1, 'opensource': 1, 'business': 1, 'industry': 3, 'mcp': 1, 'agent': 1}.
- Frontier Watchlist entities: 26; candidates_from_watchlist=94; GLM-5.2 detected=no.
- Data coverage: active_url_sources=63; active_api_sources=27; active_rss_sources=63; active_sitemap_sources=0; active_watchlist_entities=26; metadata_only_sources=46.
- Source registry P0: configured=31; checked=31; success=31; failed=0; zero_hit=0; missing_critical=[].
- Registry quality: verified_timestamp_ratio=1.0; content_quality_ratio={'full_text': 0.0, 'summary_only': 0.487, 'metadata_only': 0.513}; primary/independent/community=27/63/19.
- API candidates: total=115; by_method={'hf_api': 26, 'github_api': 42, 'arxiv_api': 0, 'api': 8}; notes=['profile AMD AI Blog: HTTP Error 404: Not Found', 'profile Intel AI Blog: HTTP Error 403: Forbidden', 'profile Arm AI Blog: The read operation timed out'].
- Input quality: real_candidate_count=666; manual_signal_count=0; weak_metadata_match_count=16; official_org_candidate_count=62.
- candidates_by_method={'github_api': 42, 'hf_api': 26, 'api': 8, 'changelog_snapshot': 5, 'rss': 26, 'metadata': 4, 'html': 529, 'gdelt': 26}; content_quality_mix={'metadata_only': 59, 'summary_only': 78, 'full_text': 529}; remaining CAPTCHA/paywall/JS-only sources=0.
- Source mix main candidates: official=14, independent=69, community=0.
- Pages workflow includes Tech Radar: yes.
- Gemini curator: success=37; fallback=63; ai_main=31; fallback_main=52.
- Section counts: local_ai=12, automation=8, open_source=5, knowledge=4, founder_ideas=10.
- /tech/ render check: knowledge=True; founder_ideas=True.
- Tests: `python tech/test_pipeline.py` and `python tech/validate_publication.py` passed.

## 2026-09-25 - Technology & AI 72h live run

- Tech72h generated_at=2026-09-25T06:14:38.209211+00:00
- Scope: standalone `tech/`; Tin48h, Invest and World LIVE logic unchanged.
- Format: AI Frontier Radar 72h.
- Schedule: once every 3 days; data window: latest 72 hours.
- Active sources: 63 / 84.
- Clean web articles: 608.
- Candidate live: 739; noise bi loai: 14; bai qua han 72h bi loai khoi section chinh: 24.
- Event candidates: 49; GDELT ran_successfully=True; raw=120; ai_filtered=49; rejected_non_ai=71.
- Query estimate: 1,438,228,130 bytes; processed: 1,438,228,130 bytes; bytes_status=known; cap: 2,000,000,000 bytes.
- Published stories: 608; must_read=20; full_link_radar=150.
- Must Read theo source type: {'independent': 12, 'official': 8}.
- Must Read theo category: {'model': 1, 'local_ai': 1, 'tool': 8, 'automation': 2, 'opensource': 1, 'business': 1, 'industry': 2, 'mcp': 2, 'agent': 2}.
- Frontier Watchlist entities: 26; candidates_from_watchlist=119; GLM-5.2 detected=no.
- Data coverage: active_url_sources=63; active_api_sources=27; active_rss_sources=63; active_sitemap_sources=0; active_watchlist_entities=26; metadata_only_sources=46.
- Source registry P0: configured=31; checked=31; success=31; failed=0; zero_hit=0; missing_critical=[].
- Registry quality: verified_timestamp_ratio=1.0; content_quality_ratio={'full_text': 0.0, 'summary_only': 0.4825, 'metadata_only': 0.5175}; primary/independent/community=27/63/19.
- API candidates: total=114; by_method={'hf_api': 27, 'github_api': 42, 'arxiv_api': 0, 'api': 8}; notes=['profile Google DeepMind Blog: not well-formed (invalid token): line 1, column 0', 'profile AMD AI Blog: HTTP Error 404: Not Found', 'profile Intel AI Blog: HTTP Error 403: Forbidden'].
- Input quality: real_candidate_count=739; manual_signal_count=0; weak_metadata_match_count=17; official_org_candidate_count=61.
- candidates_by_method={'github_api': 42, 'hf_api': 27, 'changelog_snapshot': 5, 'api': 8, 'metadata': 5, 'html': 607, 'rss': 24, 'gdelt': 21}; content_quality_mix={'metadata_only': 59, 'summary_only': 73, 'full_text': 607}; remaining CAPTCHA/paywall/JS-only sources=0.
- Source mix main candidates: official=11, independent=75, community=0.
- Pages workflow includes Tech Radar: yes.
- Gemini curator: success=43; fallback=57; ai_main=29; fallback_main=57.
